variable "rules" {
  ...
  default = {
    ...
    ## PFSense SSH
    pfsense-ssh = [6022, 6022, "tcp", "PFSense"]
    # Exolution
    exolution-port1 = [9588, 9588, "tcp", "exolution-9588"]
    exolution-port2 = [9589, 9589, "tcp", "exolution-9589"]
    # Storm
...
variable "auto_groups" {
  ...
  default = {
    ...
    exolution = {
      ingress_rules     = ["exolution-port1", "exolution-port2"]
      ingress_with_self = ["all-all"]
      egress_rules      = ["all-all"]
    }
  }
